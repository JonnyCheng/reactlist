``// 测试数据
var _score = [
    {name: '张三', gender: '男', computer: 85, chinese: 98, _id:0},
    {name: '张三', gender: '女', computer: 95, chinese: 90, _id:1},
    {name: '李四', gender: '男', computer: 65, chinese: 48, _id:2},
    {name: '大妹', gender: '女', computer: 95, chinese: 100, _id:3},
    {name: '王五', gender: '男', computer: 75, chinese: 88, _id:4},
    {name: '五六', gender: '男', computer: 75, chinese: 98, _id:5},
    {name: '二妹', gender: '女', computer: 90, chinese: 98, _id:6},
    {name: '张三', gender: '男', computer: 85, chinese: 98, _id:0},
    {name: '张三', gender: '女', computer: 95, chinese: 90, _id:1},
    {name: '李四', gender: '男', computer: 65, chinese: 48, _id:2},
    {name: '大妹', gender: '女', computer: 95, chinese: 100, _id:3},
